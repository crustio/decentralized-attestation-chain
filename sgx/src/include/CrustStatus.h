...
typedef enum _crust_status_t
{
    ...
    CRUST_SRD_INCREASE_ERROR = CRUST_MK_ERROR(0x4023),
    CRUST_SRD_DECREASE_ERROR = CRUST_MK_ERROR(0x4024),
    ...
    CRUST_STORAGE_IS_STOPPED_TASK = CRUST_MK_ERROR(0x8017),
    CRUST_STORAGE_INCOMPLETE_BLOCK = CRUST_MK_ERROR(0x8018),
